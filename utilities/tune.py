...
def transfer_learning(notes, durations):
    
    network_input, network_output, distincts, lookups = prepare_network(notes, durations)

    model = create_network(n_notes, n_durations, embed_size = 100, rnn_units = 256, use_attention = False)
